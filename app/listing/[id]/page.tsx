...
export default function ListingDetailsPage({ params }: Props) {
  const listing = mockListings.find((item) => item.id === Number(params.id));

  if (!listing) {
    return (
      <main className="min-h-screen flex items-center justify-center">
        <h1 className="text-3xl font-bold">العرض غير موجود</h1>
      </main>
    );
  }
            ...
            <div className="lg:col-span-2">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-8">
                  شقة جميلة ومشمسة في موقع ممتاز، قريبة من جميع الخدمات
                  والمرافق، مناسبة للعائلات وتتوفر على تشطيب عصري.
                </p>
              </div>
            </div>
